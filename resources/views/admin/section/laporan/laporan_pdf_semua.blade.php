@php
    ...
    if (empty($logoBase64) && file_exists($logoAbsolutePath)) {
...
<head>
    ...
    <title>Laporan Booking Keseluruhan</title>
    <style>
        body {
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="report-title">
                    <h1>Laporan Booking Keseluruhan</h1>
                    <p>Tanggal Cetak: {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</p>
                    <p>Status Termasuk: Confirmed & Cancelled</p>
                </td>
            </tr>
        </table>
    </header>
    ...
    <main>
        <table class="main-table">
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="8" class="text-center">Tidak ada data booking yang ditemukan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="summary-section">
            <table class="summary-table">
                <tr>
                    <td class="label">Total Transaksi (Diterima)</td>
